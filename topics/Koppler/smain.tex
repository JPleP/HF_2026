...
\begin{pitemize}
    ...
    \begin{pitemize}
        ...
        \item \bildf{Ringkoppler Gleichtakt}
    \end{pitemize}
    \item \Term{Gegentakt}
    \begin{pitemize}
        \item \cm  an 1 und 4: $a_1^- = \frac{1}{2}a_1, a_4^- = -\frac{1}{2}a_1$
        \item \bildf{Ringkoppler Gegentakt}
    \end{pitemize}
\end{pitemize}


\bildf{Leitungsdarstellung}
\begin{pitemize}
